...
export class WeldPlanningMassEditComponent implements OnInit {
  ...
  loadSample() {
    const sample: EditableRow[] = [
      ...
      { _id: '', _raw: {}, _errors: [], _saved: false, jointNumber: 'PI-00004', hull: 'K1002', joint: 'LO-10017', description: 'Vessel nozzle to shell', status: 'locked', priority: 'high', jointType: 'pipe', drawing: 'S7204518', drawingRev: 'C', jointDesign: 'TJ-G', weldType: 'GTAW', pipeSize: '6"', wallThickness: '0.219"', materialType1: 'SS-316', materialType2: '316L SS', rtRoot: '', rtFinal: '', ndtRoot: '', ndtEach: '', ndtFinal: '', ut: '', vt: 'X', notes: 'PWHT required', createdBy: 'Sample' },
      { _id: '', _raw: {}, _errors: [], _saved: false, jointNumber: 'ST-00005', hull: 'K1003', joint: 'ST-10012', description: 'Pipe support to beam', status: 'development', priority: 'medium', jointType: 'structural', drawing: 'H7315002', drawingRev: 'A', jointDesign: 'LJ-G', weldType: 'SMAW', pipeSize: '', wallThickness: '', materialType1: '02CS', materialType2: 'E7018', rtRoot: '', rtFinal: '', ndtRoot: '', ndtEach: '', ndtFinal: '', ut: '', vt: 'X', notes: '', createdBy: 'Sample' },
    ];
