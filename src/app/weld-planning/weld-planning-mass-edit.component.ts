        ...
        @if (isEditMode()) {
          <div style="padding: 1.5rem; border: 1px dashed var(--app-border); border-radius: 0.5rem; max-width: 600px; margin: 2rem auto; text-align: center">
            ...
            <textarea class="textarea textarea-bordered w-full" rows="4"
                      placeholder="ST-J00001, PI-J00002, ST-J00003&#10;or one per line"
...
export class WeldPlanningMassEditComponent implements OnInit {
  ...
  loadSample() {
    const sample: EditableRow[] = [
      { _id: '', _raw: {}, _errors: [], _saved: false, jointNumber: 'PI-J00001', hull: 'K1001', joint: 'FW-J10014', description: 'Main header to 4" reducer', status: 'development', priority: 'medium', jointType: 'pipe', drawing: 'H7111234', drawingRev: 'B', jointDesign: 'BJ-G', weldType: 'GTAW', pipeSize: '4"', wallThickness: '0.250"', materialType1: 'Carbon Steel', materialType2: 'ER70S-6', rtRoot: '', rtFinal: '', ndtRoot: '', ndtEach: '', ndtFinal: '', ut: '', vt: 'X', notes: '', createdBy: 'Sample' },
      { _id: '', _raw: {}, _errors: [], _saved: false, jointNumber: 'PI-J00002', hull: 'K1001', joint: 'SW-J10008', description: '90 elbow connection', status: 'unlocked', priority: 'medium', jointType: 'pipe', drawing: 'H7111234', drawingRev: 'B', jointDesign: 'FJ-G', weldType: 'SMAW', pipeSize: '3"', wallThickness: '0.219"', materialType1: 'Carbon Steel', materialType2: 'E7018', rtRoot: '', rtFinal: '', ndtRoot: '', ndtEach: '', ndtFinal: '', ut: '', vt: 'X', notes: 'Standard procedure', createdBy: 'Sample' },
      { _id: '', _raw: {}, _errors: [], _saved: false, jointNumber: 'ST-J00003', hull: 'K1002', joint: 'ST-J10005', description: 'I-beam splice connection', status: 'development', priority: 'low', jointType: 'structural', drawing: 'S7204518', drawingRev: 'A', jointDesign: 'CJ-G', weldType: 'FCAW', pipeSize: '', wallThickness: '', materialType1: 'Alloy Steel', materialType2: 'ER70S-6', rtRoot: '', rtFinal: '', ndtRoot: '', ndtEach: '', ndtFinal: '', ut: '', vt: 'X', notes: '', createdBy: 'Sample' },
      { _id: '', _raw: {}, _errors: [], _saved: false, jointNumber: 'PI-J00004', hull: 'K1002', joint: 'LO-J10017', description: 'Vessel nozzle to shell', status: 'locked', priority: 'high', jointType: 'pipe', drawing: 'S7204518', drawingRev: 'C', jointDesign: 'TJ-G', weldType: 'GTAW', pipeSize: '6"', wallThickness: '0.219"', materialType1: 'Stainless Steel 316', materialType2: '316L SS', rtRoot: '', rtFinal: '', ndtRoot: '', ndtEach: '', ndtFinal: '', ut: '', vt: 'X', notes: 'PWHT required', createdBy: 'Sample' },
      { _id: '', _raw: {}, _errors: [], _saved: false, jointNumber: 'ST-J00005', hull: 'K1003', joint: 'ST-J10012', description: 'Pipe support to beam', status: 'development', priority: 'medium', jointType: 'structural', drawing: 'H7315002', drawingRev: 'A', jointDesign: 'LJ-G', weldType: 'SMAW', pipeSize: '', wallThickness: '', materialType1: 'Carbon Steel', materialType2: 'E7018', rtRoot: '', rtFinal: '', ndtRoot: '', ndtEach: '', ndtFinal: '', ut: '', vt: 'X', notes: '', createdBy: 'Sample' },
    ];
