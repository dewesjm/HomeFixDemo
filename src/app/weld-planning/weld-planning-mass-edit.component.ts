...
export class WeldPlanningMassEditComponent implements OnInit {
  ...
  loadSample() {
    const sample: EditableRow[] = [
      ...
      { _id: '', _raw: {}, _errors: [], _saved: false, hull: 'K1002', joint: 'LO-10017', description: 'Nozzle to header', status: 'locked', priority: 'high', jointType: 'pipe', drawing: 'S7204518', drawingRev: 'C', jointDesign: 'TJ-G', weldType: 'GTAW', pipeSize: '6"', wallThickness: '0.219"', materialType1: '13-SS316', materialType2: '16-SS316', rtRoot: '', rtFinal: '', ndtRoot: '', ndtEach: '', ndtFinal: '', ut: '', vt: 'X', notes: 'PWHT required', createdBy: 'Sample' },
