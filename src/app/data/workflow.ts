...
const TRADE_STAGES: Record<Job['trade'], StageTemplate[]> = {
  ...
  Welding: [
    ...
    { id: 'tack', label: 'Tack', displayName: 'Tack', required: true, role: 'Welding', fields: [
      ...
      { key: 'actualPh', label: 'Actual PH', type: 'number' },
      { key: 'actualIp', label: 'Actual IP', type: 'number' },
    ...
    { id: 'root-weld', label: 'Root', required: true, role: 'Welding', fields: [
      { key: 'weldProcedure', label: 'Weld Procedure', type: 'select',
        options: [{ label: 'WPS-001', value: 'wps-001' }, { label: 'WPS-002', value: 'wps-002' },
          { label: 'WPS-003', value: 'wps-003' }, { label: 'WPS-004', value: 'wps-004' }] },
      { key: 'wtn', label: 'WTN', type: 'select',
