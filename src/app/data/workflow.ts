...
const TRADE_STAGES: Record<Job['trade'], StageTemplate[]> = {
  ...
  Welding: [
    ...
    { id: 'root-ndt-utrt', label: 'Root NDT UT/RT', required: true, role: 'Inspector', fields: [
      ...
      { key: 'degreeRt', label: 'Degree of RT Performed', type: 'select', showIf: { key: 'ndtMethod', equals: 'rt' },
        options: [{ label: '30%', value: '30' }, { label: '60%', value: '60' }, { label: '90%', value: '90' }] },
      { key: 'rtFileNumber', label: 'RT File Number', type: 'text', showIf: { key: 'ndtMethod', equals: 'rt' } },
      { key: 'defectCode', label: 'Defect Code', type: 'select', showIf: { key: 'ndtMethod', equals: 'rt' },
    ...
    { id: 'root-ndt-mtpt', label: 'Root NDT MT/PT', required: true, role: 'Inspector', fields: [
      ...
      { key: 'penetrantManufacturer', label: 'Penetrant Manufacturer', type: 'select', showIf: { key: 'inspectionType', equals: 'pt' },
        options: [{ label: 'Type I - Fluorescent', value: 'type-i' }, { label: 'Type II - Visible', value: 'type-ii' },
          { label: 'Type III - Water Washable', value: 'type-iii' }, { label: 'Type IV - Post Emulsifiable', value: 'type-iv' }] },
      { key: 'partial', label: 'Partial', type: 'checkbox' },
      { key: 'portionInspected', label: 'Portion of Weld Inspected', type: 'text', showIf: { key: 'partial', equals: 'yes' } },
